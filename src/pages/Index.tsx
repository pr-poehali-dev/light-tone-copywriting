...
const services = [
  ...
  },
  {
    icon: "Globe",
    title: "Сайты-визитки",
    desc: "Стильный и быстрый сайт-визитка для вашего бизнеса или личного бренда. Адаптивный дизайн, готов за несколько дней.",
    price: "от 20 000 ₽",
    tag: "Веб-разработка",
  },
  {
    ...
    title: "Полные сайты",
    desc: "Многостраничный сайт под ключ: дизайн, разработка, наполнение. Для бизнеса, которому нужен полноценный веб-присутствие.",
    price: "от 50 000 ₽",
    tag: "Веб-разработка",
  },
];
